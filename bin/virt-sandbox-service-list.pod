...
virt-sandbox-service list - list existing Secure container
...
The list command will list the security sandbox containers, an optionally the running security containers
