...
virt-sandbox-service stop - Stop a security container
...
The stop command will start a security sandbox container.
...
Stop the httpd1 container

 # virt-sandbox-service stop httpd1
